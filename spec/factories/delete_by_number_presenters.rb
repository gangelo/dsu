...
FactoryBot.define do
  factory :delete_by_number_presenter, class: 'Dsu::Presenters::Project::DeleteByNumberPresenter' do
    project_number { 2 }
    options { {} }
    ...
    trait :with_project_number do
      after(:build) do |delete_by_number_presenter, evaluator|
        ...
        delete_by_number_presenter.send(:project_number=, project_number)
      end
    end
  end
end
