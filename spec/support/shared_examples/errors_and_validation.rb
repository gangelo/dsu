...
# that are raised during initialization (i.e. where no validation)
# methods need to be called on the subject.
shared_examples 'an error is raised during initialization' do
...
# that are raised during initialization (i.e. where no validation)
# methods need to be called on the subject.
shared_examples 'no error is raised during initialization' do
